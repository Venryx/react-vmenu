...
/***/ function(module, exports, __webpack_require__) {
	...
	var VMenu = VMenu_1 = function (_BaseComponent) {
	    ...
	    _createClass(VMenu, [{
	        ...
	        value: function render() {
	            ...
	            return open && this.props.children ? React.createElement("div", { className: "VMenu", style: [styles.root, { left: pos.x, top: pos.y }] }, this.props.children) : React.createElement("div", { className: "VMenu", style: { display: "none" } });
	        }
	    }, {
	        key: "Open",
	        value: function Open(pagePos) {
	        ...
	        value: function OnMouseDown(e) {
	            if (e.button != 2) return;
	            if (VMenu_1.justOpened) return; // if higher-z-index control opened menu, don't open another one
	            this.Open(new _General.Vector2i(e.pageX, e.pageY));
	            VMenu_1.justOpened = this;
	            setTimeout(function () {
	                return VMenu_1.justOpened = null;
	            });
	        }
	    }, {
	        ...
	        value: function OnGlobalMouseDown(e) {
	            ...
	            if (VMenu_1.justOpened == this) return;
	        ...
	        value: function PostRender() {
	            if (this.props.onBody) this.PopOut();
	        }
	    }, {
	        ...
	        value: function PopOut() {
	            ...
	            this.poppedOut = true;
	            VMenu_1.onBodyMenus.push(this);
	        }
	    }, {
	        key: "PopBackIn",
	        value: function PopBackIn() {
	            if (!this.poppedOut) return;
	            //this.dom.removeEventListener("contextmenu");
	            this.domParent.appendChild(this.dom);
	            this.poppedOut = false;
	            VMenu_1.onBodyMenus.splice(VMenu_1.onBodyMenus.indexOf(this), 1);
	        }
	    }], [{
	        key: "CloseAll",
	        value: function CloseAll() {
	            ...
	            try {
	                for (var _iterator = VMenu_1.onBodyMenus[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	VMenu.onBodyMenus = [];
	VMenu.justOpened = null;
	VMenu = VMenu_1 = __decorate([_radium2.default], VMenu);
